...
def generate_bookings(engine):
    with engine.begin() as conn:
        ...
        for sf_id, departs_date, flight_status_id, seat_capacity in flights:
            ...
            occupancy    = random.uniform(0.05, 0.15) if is_cancelled else random.uniform(0.60, 0.80)
            ...
            for _ in range(num_bookings):
                ...
                batch.append({
                    ...
                    "booking_date_time":    _booking_date(departs_date),
                ...
                if len(batch) >= BATCH_SIZE:
                    conn.execute(text("""
                        ...
                        VALUES (:booking_status_id, :booking_date_time, :booking_total_amount, :booking_number)
                    """), batch)
                    batch.clear()
